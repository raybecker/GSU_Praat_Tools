...
# checkClipping is part of GSU Praat Tools 1.9. GSU Praat Tools is
# free software; you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free
# Software Foundation; either version 3 of the License, or (at your
# option) any later version.

# checkClipping is distributed in the hope that it will be useful,
...
for i from 1 to 'numberOfSelectedSounds'
  ...
  printline 'soundNumber'. Sound 'soundName$' 'clippedValues'
  Remove
endfor
printline
