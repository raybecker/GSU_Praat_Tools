...
# previousObjects is part of GSU Praat Tools 1.9. GSU Praat Tools is
# free software; you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free
# Software Foundation; either version 3 of the License, or (at your
# option) any later version.

# previousObjects is distributed in the hope that it will be useful,
...
procedure objects_sound
  ...
  # get the number of the last file in the Object window, as well as finding the
