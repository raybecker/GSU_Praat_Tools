...
# bandFiltering is part of GSU Praat Tools 1.9. GSU Praat Tools is
# free software; you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free
# Software Foundation; either version 3 of the License, or (at your
# option) any later version.

# bandFiltering is distributed in the hope that it will be useful,
...
form bandpass and bandstop Filtering
  ...
  optionmenu Band_filtering_mode 1
    option set filtering mode first
    option bandpass
    option bandstop
  comment Lower and upper band frequencies...
  real lower_frequency_(Hz) 500
  real upper_frequency_(Hz) 1000
  comment Smoothing value...
  real smoothing_bandwidth_(Hz) 100
...
procedure editor_nolabels
  ...
  # do filtering
  if ('band_filtering_mode' = 2)
    # bandpass between lower and upper frequency liimits
    Filter (pass Hann band)... 'lower_frequency' 'upper_frequency' 'smoothing_bandwidth'
   elsif ('band_filtering_mode' = 3)
    # bandstop between lower and upper frequency liimits
    Filter (stop Hann band)... 'lower_frequency' 'upper_frequency' 'smoothing_bandwidth'
  endif
  targetsegmentModifiedNumber = selected ("Sound", 1)
  targetsegmentModifiedName$ = selected$ ("Sound", 1)

  # rescale, if desired
  if ('rescale_after_filtering' = 1)
    Scale peak... 0.99
  endif
