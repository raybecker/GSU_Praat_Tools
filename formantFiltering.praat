...
# formantFiltering is part of GSU Praat Tools 1.9. GSU Praat Tools is
# free software; you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free
# Software Foundation; either version 3 of the License, or (at your
# option) any later version.

# formantFiltering is distributed in the hope that it will be useful,
...
form formant Filtering
  ...
  optionmenu Number_of_formants 1
    option set formant number first
    option 1
    option 2
    option 3
    option 4
...
# check that number of formants is set
if ('number_of_formants' = 1)
  clearinfo
  printline
  printline Error: Set number of formants
  printline
  exit
endif
...
procedure editor_nolabels
  ...
  # do filtering
  if ('number_of_formants' >= 2)
    Filter with one formant (in-line)... f1 bw1
  endif
  if ('number_of_formants' >= 3)
    Filter with one formant (in-line)... f2 bw2
   endif
  if ('number_of_formants' >= 4)
    Filter with one formant (in-line)... f3 bw3
  endif
  if ('number_of_formants' >= 5)
    Filter with one formant (in-line)... f4 bw4
  endif
  if ('number_of_formants' = 6)
    Filter with one formant (in-line)... f5 bw5
  endif
