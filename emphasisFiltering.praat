...
form emphasis Filtering
  ...
  optionmenu Emphasis_mode 1
    option set emphasis mode first
    option pre-emphasis
    option de-emphasis
  comment Set lower frequency...
  real From_frequency_(Hz) 50
  boolean Rescale_after_filtering 1
...
# check selected emphasis mode
if ('emphasis_mode' = 1)
  clearinfo
  printline
  printline Error: Select emphasis mode!
  printline
  exit
endif
...
procedure editor_nolabels
  ...
  # do filtering
  if ('emphasis_mode' = 2)
    Pre-emphasize (in-line)... 'from_frequency'
   elsif ('emphasis_mode' = 3)
    De-emphasize (in-line)... 'from_frequency'
  endif
